...
//     $.ajax({
//         type: "GET",
//         url: "http://localhost/api_toko_online/produk/list?search=" +
//             $("#search").val(),
//         dataType: "JSON",
//         success: function (response) {
//             $("#load_data").html("");
...
//             <p class="bodytext2 color-black300 m-0 px-2">${v.deskripsi.substring(0,
//             40)}</p>
//             <p class="caption m-0 py-1 px-2 text-primary">Rp. ${numFormat(v.harga
//             )}</p>
//             </a>`;
...
function tukar(id) {
    ...
    $("#md-barang").modal("show");
    $("#md-barang-title").html("Tukar Barang");
    $("#image").attr("required", false);
    $("#harga").attr("disable", true);
    $.ajax({
        type: "GET",
...
function hitung(){
    ...
    const harga_tukar = parseInt(document.getElementById("harga_tukar").value) ;
    // const total = sum ;
    const total = harga - harga_tukar ;
